    ...
    return (
        <div className={styles.CityContainer} style={{ backgroundImage: `url(${City})` }}>
            ...
            <div className={styles.AboutContainer}>
                <p>Hi, I'm Armando Monreal, a UGA graduate with a Bachelor's degree in Computer Science. I'm passionate about creating clean, functional web applications and solving real-world problems through code.</p>
                <p>I have experience working with technologies like React, JavaScript, TypeScript, Python, and mySQL and enjoy both front-end and back-end development.
